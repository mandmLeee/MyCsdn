...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private LinearLayout tabsContainer; // 存放Tabs的容器
	private ViewPager pager; // 从MainActivity中传递过来的pager

	private int tabCount; // Tab的数量

	private int currentPosition = 0;
	private int selectedPosition = 0;
	private float currentPositionOffset = 0f; // 当前位置偏移量

	private Paint rectPaint; // 矩形画笔
	private Paint dividerPaint; // 分割线画笔

	private int indicatorColor = 0xFF666666; // 滑动条颜色
	private int underlineColor = 0x1A000000; // 底部线的颜色
	private int dividerColor = 0x1A000000; // 分割线颜色 垂直方向

	private boolean shouldExpand = false;
	// true : tabsContainer addView时使用
	// width=0 height=match_parent weight=1.0f 的参数
